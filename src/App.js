...
const NowPlayingView = ({ song, isPlaying, onPlayPause, onNext, onPrev, progress, onProgressChange, duration, formatTime, onClose, isFavorite, onToggleFavorite }) => {  return (
